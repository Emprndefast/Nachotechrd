...
('NachoTechRD', 'http://localhost/nachotechrd', 'admin@nachotechrd.local', '', 'https://web.facebook.com/', '', '', '', '', '', 'USD', 'Online');
...
(4, 'NachoTechRDs', 'network', NULL, NULL, NULL),
